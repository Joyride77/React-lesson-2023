...
const Accordion = () => {
    ...
    return (
        <div>
            ...
            <Panel isActive={activeIndex === 1} onShow={() => setActiveIndex(1)} title="ТУХАЙ">
                Улаанбаатар ᠤᠯᠠᠭᠠᠨᠪᠠᠭᠠᠲᠤᠷ улаганбагатур, улаанбаатар нь Монгол Улсын нийслэл бөгөөд Монгол улсын цорын ганц саятан хот юм. 1992 оны шинэ нутаг дэвсгэрийн хуваариар үндсэн 6, дагуул 3, нийт 9 дүүрэгтэй, нутаг дэвсгэрийн хэмжээ 4,704.4 км2 газартай. 2021 оны эцсээр 1,649,172 хүн оршин сууж байна.
            </Panel>

            <Panel isActive={activeIndex === 0} onShow={() => setActiveIndex(0)} title="Этимологи">
